        ...
        <div className="flex gap-12 items-start">
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="mt-12 bg-[#051448] text-white rounded-2xl p-8">
              <h3 className="text-lg font-semibold mb-1">Contact &amp; Grievance</h3>
              <p className="text-white/60 text-sm mb-5">
                For questions, complaints, account issues, or grievances,
                contact our team.
              </p>
              <div className="grid sm:grid-cols-2 gap-3 text-sm">
                {[
                  ...
                  ["Support Email", "support@labelcroponline.com"],

...
export default function FlipkartThermalLabelCropPage() {
  ...
  const getFinalFileName = (fallbackName?: string) => {
    ...
    return fallbackName || cropResult?.fileName || "flipkart_4x6_thermal_label.pdf";
  };
    ...
    <div className="min-h-screen bg-slate-100 text-black pt-20 sm:pt-24 pb-12 px-3 sm:px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center sm:text-left mb-6 sm:mb-8">
          <div className="inline-flex items-center gap-2 bg-[#007cd7]/10 text-[#007cd7] text-xs font-bold px-3 py-1 rounded-full mb-2">
            <span>Flipkart 4×6 Thermal Label Specialist</span>
          </div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#051448] tracking-tight">
            Flipkart 4×6 Thermal Shipping Label Cropper
          </h1>
          <p className="text-xs sm:text-sm text-black/75 mt-1 max-w-2xl text-justify sm:text-left">
            Convert full A4 Flipkart Seller Hub PDFs into clean <strong>4×6 inch (100×150 mm) thermal labels</strong>. Preserves Ekart Logistics barcodes with 100% vector resolution for immediate hub scanning.
          </p>
        </div>
            ...
            <div className="lg:col-span-5 space-y-4 min-w-0">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <div className="text-xs font-bold">Custom Studio</div>
                    <div className="text-[10px] text-black/65 mt-0.5 leading-tight">
                      Visual 8-handle box
                    </div>
                  </button>
              ...
              {file && (
                <div className="pt-2 border-t border-[#051448]/15 flex flex-wrap sm:flex-nowrap items-center gap-2 min-w-0">
                  <label htmlFor="flipkart-thermal-filename" className="text-xs font-bold text-black shrink-0">
                    File Name:
                  </label>
                  <div className="relative flex-1 min-w-0 max-w-md flex items-center">
                    <input
                      id="flipkart-thermal-filename"
                      type="text"
                      value={customFileName}
                      onChange={(e) => setCustomFileName(e.target.value)}
                      placeholder={cropResult ? cropResult.fileName.replace(/\.pdf$/i, "") : "flipkart_4x6_label"}
              ...
              {cropResult && (
                <div className="mt-3 pt-2.5 border-t border-[#051448]/15 text-[11px] sm:text-xs text-black/75 flex flex-wrap items-center justify-between gap-1">
                  <span>
                    Ready: <strong className="text-black uppercase">{cropMode === "custom" ? "Custom Selected Area" : "Flipkart 4×6 Label"}</strong>
                  </span>
        ...
        <div className="mt-10 sm:mt-14 space-y-8 sm:space-y-12 text-black">
          ...
          <div className="bg-white border border-[#051448]/20 rounded-md p-5 sm:p-8 shadow-xs">
            <div className="inline-flex items-center gap-2 bg-[#051448]/10 text-[#051448] text-xs font-bold px-3 py-1 rounded-full mb-3">
              <span>Flipkart 4×6 Printing Guide &amp; Cropper</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#051448] mb-3">
              How to Crop &amp; Print Flipkart Shipping Labels on 4×6 Thermal Printers
            </h2>
            <p className="text-xs sm:text-sm text-black/80 leading-relaxed mb-4 text-justify">
              When packaging daily eCommerce orders for <strong>Flipkart Seller Hub</strong>, printing full A4 sheets wastes sticky sticker roll paper and requires tedious manual scissor trimming. Standard 4×6 thermal rolls (100×150 mm) are fast, self-adhesive, and water-resistant, making them the preferred dispatch solution for top sellers.
            </p>
            <p className="text-xs sm:text-sm text-black/80 leading-relaxed text-justify">
              <strong>LabelCropOnline</strong> automatically crops the upper shipping label from your Flipkart invoices with millimeter-exact symmetrical margins. Every Ekart Logistics barcode, OD tracking ID, and hub sorting code retains <strong>100% vector clarity</strong> for flawless first-pass scan rates at pickup hubs.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            <div className="p-4 sm:p-5 bg-white border border-[#051448]/20 rounded-md shadow-xs">
              ...
              <h4 className="font-bold text-sm text-black mb-1.5">Direct Thermal Ready</h4>
              <p className="text-xs text-black/75 leading-relaxed text-justify">
                Calibrated specifically for 4×6 inch (100×150 mm) thermal rolls used in TVS, TSC, Zebra, Rollo, and Xprinter barcode printers.
              </p>
            </div>
            ...
            <div className="p-4 sm:p-5 bg-white border border-[#051448]/20 rounded-md shadow-xs">
              ...
              <h4 className="font-bold text-sm text-black mb-1.5">100% Vector Quality</h4>
              <p className="text-xs text-black/75 leading-relaxed text-justify">
                Maintains original PDF vector commands so Ekart 1D/2D barcodes print with sharp, crisp lines and high scan contrast.
              </p>
            </div>
            ...
            <div className="p-4 sm:p-5 bg-white border border-[#051448]/20 rounded-md shadow-xs">
              ...
              <h4 className="font-bold text-sm text-black mb-1.5">Zero Cloud Uploads</h4>
              <p className="text-xs text-black/75 leading-relaxed text-justify">
                All cropping and processing run locally in your web browser. Customer shipping addresses and seller data remain 100% private.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#051448]/20 rounded-md p-5 sm:p-8 shadow-xs">
            <h3 className="text-base sm:text-lg font-bold text-[#051448] mb-4">
              Recommended Printer Settings for Flipkart 4×6 Thermal Labels
            </h3>
            <div className="grid sm:grid-cols-2 gap-4 text-xs sm:text-sm">
              <div className="p-4 bg-slate-50 border border-slate-200 rounded">
                ...
                <ul className="space-y-1.5 text-black/75 list-disc list-inside">
                  <li><strong>Destination:</strong> Select your 4×6 Thermal Printer</li>
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded">
                ...
                <ul className="space-y-1.5 text-black/75 list-disc list-inside">
                  ...
                  <li><strong>Darkness / Density:</strong> Level 10 to 14</li>
                  <li><strong>Media Type:</strong> Direct Thermal / Label with Gaps</li>
                  <li><strong>Sensor Type:</strong> Transmissive / Gap Sensor</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      {file && (
        <CustomPdfCropModal
          ...
          title="Custom Crop Area (Flipkart PDF)"
          ...
          <div className="bg-white border border-[#051448] rounded-md w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
            <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 px-3 sm:px-5 py-2.5 sm:py-3 border-b border-[#051448] bg-slate-50">
              <div className="flex items-center gap-2 min-w-0">
                <span className="font-bold text-xs sm:text-sm text-black truncate">Flipkart 4×6 Preview</span>

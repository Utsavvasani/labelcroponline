            ...
            <div className="max-w-[1200px] mx-auto px-6 py-10">
                <div className="grid lg:grid-cols-3 gap-8 items-start">
                    ...
                    <main className="lg:col-span-2">
                        {submitted ? (
                            <div className="flex flex-col items-center justify-center text-center border border-[#051448] rounded-md p-10">
                                ...
                                <h2 className="text-lg font-bold text-[#051448] mb-2">Message Sent!</h2>
                                <p className="text-slate-600 text-sm max-w-sm leading-relaxed">
                                    Thank you for reaching out. We'll get back to you at{" "}
                                    <span className="font-semibold text-[#051448]">{formData.email}</span> within 24 hours.
                                </p>
                                <button
                            ...
                            >
                                <div>
                                    <h2 className="text-lg font-bold text-[#051448] mb-0.5">Send us a message</h2>
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-xs font-bold text-[#051448] uppercase tracking-wide mb-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-[#051448] rounded px-3 py-2 text-sm text-[#051448] font-medium placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-1 focus:ring-[#051448]/30 transition-all bg-white"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-bold text-[#051448] uppercase tracking-wide mb-1">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full border border-[#051448] rounded px-3 py-2 text-sm text-[#051448] font-medium placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-1 focus:ring-[#051448]/30 transition-all resize-none bg-white"
                                    />
                                </div>
                    ...
                    <aside className="lg:col-span-1 flex flex-col gap-5 pt-1">
                        <h2 className="text-base font-bold text-[#051448]">Contact Information</h2>
                        <div className="space-y-4">
                            <a href="tel:+919909520532" className="flex items-start gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#051448] font-semibold text-sm group-hover:opacity-70 transition-opacity">
                                        +91 99095 20532
                                    </p>
                                </div>
                            </a>
                            <a href="mailto:labelcroponline@gmail.com" className="flex items-start gap-3 group">
                                ...
                                <div>
                                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-400 mb-0.5">Email</p>
                                    <p className="text-[#051448] font-semibold text-sm group-hover:opacity-70 transition-opacity break-all">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-400 mb-0.5">Location</p>
                                    <p className="text-[#051448] font-semibold text-sm">India</p>
                                </div>
                            </div>
                        </div>
                    </aside>

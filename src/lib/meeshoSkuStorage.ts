/**
 * Secure, localStorage-backed persistence for the seller's preferred Meesho SKU order & product groups.
 *
 * Keys:
 * - "lco_meesho_sku_order"
 * - "lco_meesho_sku_groups"
 */
...
const STORAGE_KEY = "lco_meesho_sku_order";
const GROUPS_STORAGE_KEY = "lco_meesho_sku_groups";

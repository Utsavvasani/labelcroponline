      ...
      >
        ...
        <div className="bg-[#051448] w-full px-4 py-3 text-white">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              href="tel:+918141925344"
              className="flex items-center gap-2 text-sm text-white/80 hover:text-white transition-colors"
            >
              <Phone size={16} />
              <span className="hidden sm:inline">+91 81419 25344</span>
            </a>
            <a
              href="mailto:info@labelcrop.online"
              className="flex items-center gap-2 text-sm text-white/80 hover:text-white transition-colors"
            >
              <Mail size={16} />
              <span className="hidden sm:inline">info@labelcrop.online</span>
            </a>
          </div>

    ...
    <footer className="bg-[#051448] text-white">
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            ...
            <p className="text-sm text-white/70 leading-relaxed">
              Free online tools for cropping shipping labels, merging PDFs, and processing documents — all directly in your browser with zero data upload.
            </p>
          </div>

          {/* Label Tools */}
          <div className="space-y-4">
            <h4 className="font-semibold text-base tracking-wide">Label Tools</h4>
            <ul className="space-y-2 text-sm text-white/70">
              <li><Link href="/meesho-label-crop" className="hover:text-white transition-colors">Meesho Label Crop</Link></li>
              <li><Link href="/flipkart-label-crop" className="hover:text-white transition-colors">Flipkart Label Crop</Link></li>
              ...
              <li><Link href="/pdf-to-images" className="hover:text-white transition-colors">PDF to Images</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 pt-1 text-white/70">
              <a href="https://linkedin.com/company/labelcroponline" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LabelCropOnline on LinkedIn">
              ...
              <a href="https://instagram.com/labelcroponline" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LabelCropOnline on Instagram">
              ...
              <a href="https://facebook.com/labelcroponline" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LabelCropOnline on Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>
              <a href="https://twitter.com/labelcroponline" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LabelCropOnline on X (Twitter)">
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/50">
          <span>© {new Date().getFullYear()} LabelCropOnline. All rights reserved.</span>
